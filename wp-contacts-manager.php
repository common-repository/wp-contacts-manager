...
add_filter('plugin_action_links_'.WP_CONTACTS_MANAGER_PLUGIN_BASE_NAME,'lab_custom_link_premium'); 

function lab_custom_link_premium ($links)
    {
	$links[] = '<a href="https://labarta.es/wp-contacts-manager-plugin-wordpress/" target="_blank" rel="noopener noreferrer"><strong style="display: inline;">'.__('Upgrade to Premium', 'wp_contacts_manager').'</strong></a>';
